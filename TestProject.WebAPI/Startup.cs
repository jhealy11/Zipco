...
namespace TestProject.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Data.ZipContext>(options => options.UseSqlServer(Configuration.GetConnectionString("ZipContext")));
